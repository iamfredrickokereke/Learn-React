...
function BookList() {
    return (
        <section className="booklist">
            ...
            <Book img={secondBook.img} title={secondBook.title} author={secondBook.author}/>
            <Book img={thirdBook.img} title={thirdBook.title} author={thirdBook.author}/>
            <Book img={firstBook.img} title={firstBook.title} author={firstBook.author}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem quaerat asperiores iure nesciunt velit nihil voluptas officia quas accusantium commodi aut repellat temporibus nulla quidem minima, amet voluptatibus quibusdam provident?</Book>
        </section>
    )
}
